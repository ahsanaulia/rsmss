// lib/features/stock/views/stock_write_off_form_page.dart
import 'dart:ui';
...
class StockWriteOffFormPage extends ConsumerStatefulWidget {
  const StockWriteOffFormPage({super.key});

  @override
  ConsumerState<StockWriteOffFormPage> createState() =>
      _StockWriteOffFormPageState();
}

class _StockWriteOffFormPageState extends ConsumerState<StockWriteOffFormPage> {
                                      ...
                                      children: [
                                        ...
                                        Wrap(
                                          ...
                                          children: [
                                            ...
                                            _buildChip(
                                              'Stok: ${item.systemQuantity.toStringAsFixed(0)} ${item.unit}',
                                              Colors.blue,
                                            ),
                                          ],
                                        ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text(
                                    'Batch: ${state.selectedItem!.batchNumber} | Exp: ${_formatDate(state.selectedItem!.expiryDate)}',
                                    style: GoogleFonts.poppins(fontSize: 11),
                                  ),
                                  Text(
                                    'Stok Tersedia: ${state.selectedItem!.systemQuantity.toStringAsFixed(0)} ${state.selectedItem!.unit}',
                                    style: GoogleFonts.poppins(
                                      fontSize: 11,
                            ...
                            TextFormField(
                              ...
                              onChanged: (value) => notifier.updateQuantity(
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              items: const [
                                ...
                                DropdownMenuItem(
                                  value: 'CONTAMINATED',
                                  child: Text('Terkontaminasi'),
                                ),
                                DropdownMenuItem(
                                  value: 'RECALL',
                                  child: Text('Recall Produk'),
                                ),
                              ],
                              onChanged: (value) =>
                        ...
                        child: ElevatedButton.icon(
                          onPressed: state.isSaving
                              ...
                              : () async {
                                  ...
                                  if (state.selectedItem != null &&
                                      quantity >
                                          state.selectedItem!.systemQuantity) {
                                  ...
                                  // TUTUP FORM LANGSUNG (anggap berhasil)
                                  if (mounted) {
