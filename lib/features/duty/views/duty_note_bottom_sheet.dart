  ...
  Future<void> _saveDutyNote() async {
    ...
    if (noteText.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("Catatan tidak boleh kosong", style: GoogleFonts.poppins()),
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Catatan berhasil disimpan", style: GoogleFonts.poppins()),
...
Widget build(BuildContext context) {
  ...
  return Container(
    padding: EdgeInsets.only(
      ...
      right: 24,
      top: 24,
      bottom: bottomPadding + 24,  // ← KEY: bottom sheet naik
    ),
