// lib/features/stock_request/presentations/stock_request_form_mobile.dart
...
class StockRequestFormMobile extends ConsumerStatefulWidget {
  const StockRequestFormMobile({super.key});

  @override
  ConsumerState<StockRequestFormMobile> createState() => _StockRequestFormMobileState();
}

class _StockRequestFormMobileState extends ConsumerState<StockRequestFormMobile> {
  ...
  // Untuk multiple request (opsi "Tambah Request Lagi")
  ...
  Future<void> _generateRequestNumber() async {
    setState(() => _isLoading = true);
    final controller = ref.read(stockRequestControllerProvider);
    await controller.generateRequestNumber();
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final request = StockRequestModel(
        ...
        requesterId: '', // Akan diisi service
        requesterName: '', // Akan diisi service
          ...
          Form(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // Informasi Peminta (otomatis dari login)
                  Card(
                    ...
                    data: (rooms) => DropdownButtonFormField<String>(
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          _selectedRoomName = selected['room_name'] as String?;
                        });
                      },
                  ...
                  CheckboxListTile(
                    title: const Text('Tambah Request Lagi'),
                    subtitle: const Text('Centang jika ingin membuat request lain setelah ini'),
                    value: _continueAdding,
                    onChanged: (value) {
                      setState(() => _continueAdding = value ?? false);
                    },
