...
class ScoringCategoryService {
  final SupabaseClient _supabase = Supabase.instance.client;
  final String _tableName = 'scoring_categories';
  ...
  Future<List<Map<String, dynamic>>> getAll() async {
    ...
    try {
      ...
      throw Exception('Gagal mengambil data kategori scoring: $e');
    }
  }
  ...
  Future<Map<String, dynamic>?> getById(String id) async {
    ...
    try {
      ...
      debugPrint('📚 [Service] StackTrace: $stackTrace');
      throw Exception('Gagal mengambil detail kategori scoring: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> insert(Map<String, dynamic> data) async {
    ...
    try {
      ...
      debugPrint('📚 [Service] StackTrace: $stackTrace');
      throw Exception('Gagal menambah kategori scoring: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> update(String id, Map<String, dynamic> data) async {
    ...
    try {
      ...
      debugPrint('📚 [Service] StackTrace: $stackTrace');
      throw Exception('Gagal mengupdate kategori scoring: $e');
    }
  }
  ...
  Future<void> delete(String id) async {
    ...
    try {
      // Cek apakah kategori scoring digunakan di tabel lain
      // Jika ada tabel yang mereferensi, tambahkan pengecekan di sini
      // Contoh: cek di tabel scoring_items atau scoring_results
      ...
      debugPrint('📚 [Service] StackTrace: $stackTrace');
      throw Exception('Gagal menghapus kategori scoring: $e');
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getActiveCategories() async {
    ...
    try {
      final response = await _supabase
          .from(_tableName)
          .select('id, category_code, category_name, weight')
          .eq('is_active', true)
          .order('category_name', ascending: true);
