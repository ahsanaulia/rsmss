...
class RefStockCategoryService {
  final SupabaseClient _supabase = Supabase.instance.client;
  final String _tableName = 'ref_stock_categories';
  ...
  Future<List<Map<String, dynamic>>> getAllCategories() async {
    ...
    try {
      ...
      throw Exception('Gagal mengambil data kategori stok: $e');
    }
  }
  ...
  Future<Map<String, dynamic>?> getCategoryById(String id) async {
    ...
    try {
      ...
      debugPrint('📚 [Service] StackTrace: $stackTrace');
      throw Exception('Gagal mengambil detail kategori stok: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> insertCategory(Map<String, dynamic> data) async {
    ...
    try {
      ...
      if (e.toString().contains('ref_stock_categories_category_name_key')) {
        throw Exception('Nama kategori stok sudah ada. Gunakan nama lain.');
      }
      throw Exception('Gagal menambah kategori stok: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> updateCategory(String id, Map<String, dynamic> data) async {
    ...
    try {
      ...
      throw Exception('Gagal mengupdate kategori stok: $e');
    }
  }
  ...
  Future<void> deleteCategory(String id) async {
    ...
    try {
      ...
      debugPrint('📚 [Service] StackTrace: $stackTrace');
      throw Exception('Gagal menghapus kategori stok: $e');
    }
  }
