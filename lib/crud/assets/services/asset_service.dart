...
//   /// -----------------------------------------------------------------
//   /// FETCH SEMUA ASET (dari view v_asset_details)
//   /// -----------------------------------------------------------------
...
//   /// -----------------------------------------------------------------
//   /// FETCH SATU ASET BERDASARKAN ID (dari view v_asset_details)
//   /// -----------------------------------------------------------------
...
//   /// -----------------------------------------------------------------
//   /// PARSING RESPONSE DARI VIEW KE ASSET MODEL
//   /// -----------------------------------------------------------------
//   /// View v_asset_details sudah mengandung semua field yang diperlukan:
//   /// - Semua kolom dari tabel assets
//   /// - type_name, sub_category_name, category_name
//   /// - room_name
//   /// - registered_by_name, updated_by_name, last_used_by_name
//   /// -----------------------------------------------------------------
...
//       // Klasifikasi (langsung dari view)
...
//   /// -----------------------------------------------------------------
//   /// FETCH SEMUA ROOM (untuk dropdown last_room_id)
//   /// -----------------------------------------------------------------
...
//   /// -----------------------------------------------------------------
//   /// FETCH SEMUA ASSET TYPES (untuk dropdown type_id)
//   /// -----------------------------------------------------------------
//   /// Mengambil dari tabel ref_asset_types
//   /// Format display: "Category → Sub Category → Type" (jika ada data)
//   /// -----------------------------------------------------------------
...
//     } catch (e) {
//       // Jika gagal karena foreign key tidak ada, fallback ke query sederhana
//       return await _fetchAllAssetTypesSimple();
//     }
//   }

//   /// -----------------------------------------------------------------
//   /// FETCH ASSET TYPES - FALLBACK SEDERHANA (tanpa join)
//   /// -----------------------------------------------------------------
...
//   /// -----------------------------------------------------------------
//   /// FETCH SEMUA MAINTENANCE PATTERNS (nilai unik dari database)
//   /// -----------------------------------------------------------------
...
//   /// -----------------------------------------------------------------
//   /// DELETE: Hapus Aset (Soft Delete via is_active = `false`)
//   /// -----------------------------------------------------------------
...
//   Future<String> uploadAssetPhoto(File file, String assetId) async {
//     try {
...
//   // ==========================================================
//   // SECTION 5: SEARCH DAN FILTER (UNTUK LIST VIEW)
//   // ==========================================================

//   /// -----------------------------------------------------------------
//   /// SEARCH ASET BERDASARKAN KEYWORD (menggunakan view)
//   /// -----------------------------------------------------------------
...
//   /// -----------------------------------------------------------------
//   /// FILTER ASET BERDASARKAN STATUS KONDISI (menggunakan view)
//   /// -----------------------------------------------------------------
