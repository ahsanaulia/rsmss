...
class RefStockTypeService {
  final SupabaseClient _supabase = Supabase.instance.client;
  final String _tableName = 'ref_stock_types';
  ...
  Future<List<Map<String, dynamic>>> getAllTypes() async {
    ...
    try {
      ...
      throw Exception('Gagal mengambil data tipe stok: $e');
    }
  }
  ...
  Future<Map<String, dynamic>?> getTypeById(String id) async {
    ...
    try {
      ...
      debugPrint('📚 [Service] StackTrace: $stackTrace');
      throw Exception('Gagal mengambil detail tipe stok: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> insertType(Map<String, dynamic> data) async {
    ...
    try {
      ...
      if (e.toString().contains('ref_stock_types_sub_category_id_type_name_key')) {
        throw Exception('Nama tipe stok sudah ada di sub-kategori yang sama.');
      }
      throw Exception('Gagal menambah tipe stok: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> updateType(String id, Map<String, dynamic> data) async {
    ...
    try {
      ...
      throw Exception('Gagal mengupdate tipe stok: $e');
    }
  }
  ...
  Future<void> deleteType(String id) async {
    ...
    try {
      ...
      debugPrint('📚 [Service] StackTrace: $stackTrace');
      throw Exception('Gagal menghapus tipe stok: $e');
    }
  }
